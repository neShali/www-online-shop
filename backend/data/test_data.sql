...
INSERT INTO categories (id, name, description, parent_id) VALUES
                                                              ...
                                                              (4, 'Tops (m)', 'Men''s tops', 1),
                                                              (5, 'Bottoms (m)', 'Men''s bottoms', 1),
                                                              (6, 'Outerwear (m)', 'Men''s outerwear', 1),
                                                              (7, 'Tops (w)', 'Women''s tops', 2),
                                                              (8, 'Bottoms (w)', 'Women''s bottoms', 2),
                                                              (9, 'Dresses (w)', 'Women''s dresses', 2),
                                                              (10, 'Outerwear (w)', 'Women''s outerwear', 2),
...
('SUMMER50',   50, NULL, 100, true, '2025-06-01', '2025-08-31'),  -- id = 1
('OUTERWEAR30',30, NULL, 150, true, '2025-10-01', '2025-12-01'),  -- id = 2
('ONLINE70',   70, NULL, 80,  true, '2025-01-01', '2025-12-31'),  -- id = 3
('BASICS20',   20, NULL, 50,  true, '2025-07-01', '2025-09-30'),  -- id = 4
('KIDSFEST15', 15, NULL, 40,  true, '2025-08-01', '2025-09-15'),  -- id = 5
('FALLSET25',  25, NULL, 120, true, '2025-09-01', '2025-10-31');  -- id = 6

-- Промо 1: SUMMER50
INSERT INTO product_promos (product_id, promo_id) VALUES
(9, 1), (10, 1), (28, 1), (30, 1), (33, 1);

-- Промо 2: OUTERWEAR30
INSERT INTO product_promos (product_id, promo_id) VALUES
(35, 2), (36, 2), (37, 2), (38, 2), (40, 2);

-- Промо 3: ONLINE70
INSERT INTO product_promos (product_id, promo_id) VALUES
(11, 3), (24, 3), (29, 3), (32, 3), (34, 3);

-- Промо 4: BASICS20
INSERT INTO product_promos (product_id, promo_id) VALUES
(1, 4), (4, 4), (8, 4), (19, 4), (27, 4);

-- Промо 5: KIDSFEST15
INSERT INTO product_promos (product_id, promo_id) VALUES
(17, 5), (18, 5), (20, 5), (21, 5), (22, 5);

-- Промо 6: FALLSET25
INSERT INTO product_promos (product_id, promo_id) VALUES
(6, 6), (7, 6), (8, 6), (36, 6), (41, 6);