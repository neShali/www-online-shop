...
export const updateCategoryMutationKey = () => [{ url: '/api/v1/categories/{category_id}' }] as const
...
export async function updateCategory(
  ...
  config: Partial<RequestConfig<UpdateCategoryMutationRequest>> & { client?: typeof client } = {},
) {
  const { client: request = client, ...requestConfig } = config

  const res = await request<UpdateCategoryMutationResponse, ResponseErrorConfig<UpdateCategory422>, UpdateCategoryMutationRequest>({
    method: 'PUT',
...
export function useUpdateCategory<TContext>(
  options: {
    mutation?: UseMutationOptions<
      ...
      { category_id: UpdateCategoryPathParams['category_id']; data?: UpdateCategoryMutationRequest },
      TContext
    > & { client?: QueryClient }
    client?: Partial<RequestConfig<UpdateCategoryMutationRequest>> & { client?: typeof client }
  } = {},
) {
