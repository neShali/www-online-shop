...
import type { DeleteProductMutationResponse, DeleteProductPathParams, DeleteProduct422 } from '../../types/productsTypes/DeleteProduct'
import { useMutation } from '@tanstack/react-query'

export const deleteProductMutationKey = () => [{ url: '/api/v1/products/{product_id}' }] as const
...
export async function deleteProduct(
  ...
  const res = await request<DeleteProductMutationResponse, ResponseErrorConfig<DeleteProduct422>, unknown>({
    method: 'DELETE',
...
export function useDeleteProduct<TContext>(
  ...
  return useMutation<DeleteProductMutationResponse, ResponseErrorConfig<DeleteProduct422>, { product_id: DeleteProductPathParams['product_id'] }, TContext>(
    {
