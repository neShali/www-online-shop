 ...
 */
export async function getMyCart(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function getMyCartQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
 ...
 * {@link /api/v1/carts/me}
 */
export function useGetMyCart<TData = GetMyCartQueryResponse, TQueryData = GetMyCartQueryResponse, TQueryKey extends QueryKey = GetMyCartQueryKey>(
  options: {
    query?: Partial<QueryObserverOptions<GetMyCartQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & { client?: QueryClient }
