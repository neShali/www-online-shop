...
import type { DeletePromoMutationResponse, DeletePromoPathParams, DeletePromo422 } from '../../types/promosTypes/DeletePromo'
import { useMutation } from '@tanstack/react-query'

export const deletePromoMutationKey = () => [{ url: '/api/v1/promos/{promo_id}' }] as const
...
export async function deletePromo(
  ...
  const res = await request<DeletePromoMutationResponse, ResponseErrorConfig<DeletePromo422>, unknown>({
    method: 'DELETE',
...
export function useDeletePromo<TContext>(
  ...
  return useMutation<DeletePromoMutationResponse, ResponseErrorConfig<DeletePromo422>, { promo_id: DeletePromoPathParams['promo_id'] }, TContext>(
    {
