...
import type {
  ...
  DeleteReviewPathParams,
  DeleteReview422,
} from '../../types/reviewsTypes/DeleteReview';
import { useMutation } from '@tanstack/react-query';

export const deleteReviewMutationKey = () =>
  [{ url: '/api/v1/reviews/{review_id}' }] as const;

export type DeleteReviewMutationKey = ReturnType<
  typeof deleteReviewMutationKey
>;
